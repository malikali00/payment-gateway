...
';
    ...
    public function __construct(OrderRow $Order, MerchantRow $Merchant) {
        ...
        if(!$Merchant->getMainEmailID())
            throw new \InvalidArgumentException("Merchant does not have an email set: " . $Merchant->getUID());
...
HTML;
        ...
        $this->to = array(
            $Merchant->getMainEmailID() => $Order->getPayeeFullName()
        );
        $this->bcc = array(
